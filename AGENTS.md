...
├── skillManager.ts      # Skill install/upgrade/delete + metadata + sync hooks
├── skillSyncResolver.ts # Pure sync decisions (symlink vs copy, conflict detect)
├── skillSyncTargets.ts  # Default sync-target factory + kv reconcile
