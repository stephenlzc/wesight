# Issue #4: Configurable Skill Repositories + Marketplace Aggregation

## English

**Title:** `feat(skill): configurable skill repositories and marketplace aggregation`

**Labels:** `enhancement`, `skill`, `marketplace`
...
**标题：** `feat(skill): 可配置 Skill 仓库与市场聚合`
