# Issue #3: Local Modification Detection + Import/Export Archives

## English

**Title:** `feat(skill): detect local modifications and support skill archive import/export`
...
**标题：** `feat(skill): 本地修改检测与 Skill 归档导入导出`
